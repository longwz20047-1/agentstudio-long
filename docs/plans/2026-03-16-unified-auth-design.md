...
| 2 | weknora-ui | `api/a2a/index.ts` | 改 | A1: 4 函数加 getToken + 401 重试；A2: getA2AHistory 内部查 serverStorage 获取 ADMIN_PW |
...
| 9 | weknora-ui | `views/a2a-chat/index.vue` | 改 | ActiveSessionsPanel 移除 :api-key 绑定 |
